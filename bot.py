...
================================================================================
FEW-SHOT EXAMPLE（学习结构和语气，不要照搬内容。范例中的项目是奶茶加盟，你的判决必须针对用户发来的具体项目。）
================================================================================
以下是一个正确输出的范例：
...
- 伤官在加盟SOP里发不了力，一想做出不同就追加无效投入
【交叉】命要自己当庄 / 项目要你给总部打工
匹配：模式2/10 行业3/10 团队4/10 总3/10
【判决】DOOMED
【一句话】你不是在加盟品牌，你是在给总部当韭菜，还得自己交铲子钱。

【深度处刑】
【怎么死】
第一层：加盟费和保证金先抽走现金，开业后总部按月收管理费、强制从总部进原料，你的毛利被两头切。等你发现不赚钱，转让费已经沉没。
第二层：伤官生财的人要的是"我定规则"，加盟合约里你连杯套都不能换。三个月后你开始"优化配方""调整装修"，每一次调整都是违约罚款，不调整则憋到内伤。
第三层：2027丁未年燥土旺，供应链和履约成本同时上涨；2028戊申年如果硬开第二店，现金流直接断裂。
【大运】己未大运忌神运，只适合小切口打样，不适合铺店、不适合借钱扩张。窗口给的是"自己开一刀"，拿去买加盟资格是方向反了。
【合伙人】别找官杀型搭档来"管你"，伤官被管就内耗。要么100%自己控规则，要么只找能把货和店跑通但不碰决策的人。
【融资】这个BP不该融。融到的钱会变成更多加盟费和装修款，加速送死。有钱先验证自营单店单位经济，没有正毛利就停。
【下一刀】停掉加盟谈判。同一套国风概念只开1家自营，90天看单店能不能活。活不下来，项目结案。
【创始人评级】伤官生财有爆发力，但加盟模式锁死天花板。预估身价区间：转自营能验证单店模型并复制，上限千万级；坚持加盟路径大概率亏本。

注意：范例中【怎么死】没有重复【致命结构】的原话，而是展开了三层新因果。【一句话】没有软词。【下一刀】是命令句，具体到90天。所有建议针对奶茶加盟这个具体项目，不是通用运营建议。
